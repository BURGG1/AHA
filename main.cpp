				...
				if (acc == 1) {// if admin have the access
					...
					for (int j = 0;;) {
						...
						if (d == -32) {
							d = _getch();
							if (d == 72 || d == 75) {
								hdc(1); coorxy(30, 4); cout << string(50, ' '); hdc(0);
								counter = 21;
								break;
							}
							else if (d == 80 || d == 77) {
			...
			case 19:
				if (acc == 1) {
					...
					if (a == -32) {
						...
						{
							hdc(1);
							gotoxy(40, 4); color(4); cout << "Please fill up all the information needed"; color(7);
							Sleep(800); gotoxy(45, 4); cout << string(45, ' ');
						}
						//finding the empty file - done
